  ...
  add_file("apollo.proto", :syntax => :proto3) do
    ...
    add_message "Trace.QueryPlanNode" do
      oneof :node do
        ...
        optional :defer, :message, 5, "Trace.QueryPlanNode.DeferNode"
        optional :condition, :message, 6, "Trace.QueryPlanNode.ConditionNode"
      end
    end
    ...
    add_message "Trace.QueryPlanNode.DeferNode" do
      optional :primary, :message, 1, "Trace.QueryPlanNode.DeferNodePrimary"
      repeated :deferred, :message, 2, "Trace.QueryPlanNode.DeferredNode"
    end
    add_message "Trace.QueryPlanNode.ConditionNode" do
      optional :condition, :string, 1
      optional :if_clause, :message, 2, "Trace.QueryPlanNode"
      optional :else_clause, :message, 3, "Trace.QueryPlanNode"
    end
    add_message "Trace.QueryPlanNode.DeferNodePrimary" do
      optional :node, :message, 1, "Trace.QueryPlanNode"
    end
    add_message "Trace.QueryPlanNode.DeferredNode" do
      repeated :depends, :message, 1, "Trace.QueryPlanNode.DeferredNodeDepends"
      optional :label, :string, 2
      optional :path, :message, 3, "Trace.QueryPlanNode.ResponsePathElement"
      optional :node, :message, 4, "Trace.QueryPlanNode"
    end
    add_message "Trace.QueryPlanNode.DeferredNodeDepends" do
    ...
    add_message "ReferencedFieldsForType" do
      repeated :field_names, :string, 1
      optional :is_interface, :bool, 2
    end
    add_message "Report" do
      optional :header, :message, 1, "ReportHeader"
      map :traces_per_query, :string, :message, 5, "TracesAndStats"
      optional :end_time, :message, 2, "google.protobuf.Timestamp"
      optional :operation_count, :uint64, 6
    end
    add_message "ContextualizedStats" do
      optional :context, :message, 1, "StatsContext"
      optional :query_latency_stats, :message, 2, "QueryLatencyStats"
      map :per_type_stat, :string, :message, 3, "TypeStat"
    end
    add_message "TracesAndStats" do
      repeated :trace, :message, 1, "Trace"
      repeated :stats_with_context, :message, 2, "ContextualizedStats"
      map :referenced_fields_by_type, :string, :message, 4, "ReferencedFieldsForType"
      repeated :internal_traces_contributing_to_stats, :message, 3, "Trace"
    end
  end
end
...
Trace::QueryPlanNode::DeferNode = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("Trace.QueryPlanNode.DeferNode").msgclass
Trace::QueryPlanNode::ConditionNode = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("Trace.QueryPlanNode.ConditionNode").msgclass
Trace::QueryPlanNode::DeferNodePrimary = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("Trace.QueryPlanNode.DeferNodePrimary").msgclass
Trace::QueryPlanNode::DeferredNode = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("Trace.QueryPlanNode.DeferredNode").msgclass
Trace::QueryPlanNode::DeferredNodeDepends = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("Trace.QueryPlanNode.DeferredNodeDepends").msgclass
...
ReferencedFieldsForType = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("ReferencedFieldsForType").msgclass
Report = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("Report").msgclass
ContextualizedStats = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("ContextualizedStats").msgclass
TracesAndStats = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("TracesAndStats").msgclass
